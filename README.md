...
**[Todo  List]** is an HTML, CSS and JavaScript project to showcase my HTML, CSS, JavaScript, Bundler and GitHub Knowledge
...
<a href="[https://mohashyne.github.io/Todo_list/dist"> here </a></p>
...
```sh
cd my-folder
git clone https://github.com/mohashyne/Todo_list.git
```
...
Feel free to check the <a href="https://github.com/mohashyne/Todo_list/issues">issues page</a>.
